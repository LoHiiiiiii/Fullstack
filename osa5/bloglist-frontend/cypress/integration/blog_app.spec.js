describe('Blog app', function () {
    ...
    describe('When logged in', function () {
        ...
        it('blogs are sorted corretly', function () {
            ...
            cy.contains('author2').contains('likes 1').parent().contains('like').click()

            cy.contains('author3').contains('view').click()
            cy.contains('author3').contains('like').click()
            cy.contains('author3').contains('likes 1').parent().contains('like').click()
            cy.contains('author3').contains('likes 2').parent().contains('like').click()

            cy.contains('author3').contains('likes 3').get('.likes').then((likes) => {
